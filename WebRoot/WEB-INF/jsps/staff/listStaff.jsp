...
<script type="text/javascript">
	...
	//a标签提交表单
	function condition(){
		var form = document.getElementById("conditionFormId");
		form.submit();
	}
...
<body>
	...
	<table border="0" cellspacing="0" cellpadding="0" class="wukuang"
		...
		<tr>
			...
			<td width="57%" align="right">
				<%--高级查询 --%> <a href="javascript:void(0)" onclick="condition()"><img
					src="${pageContext.request.contextPath}/images/button/gaojichaxun.gif" /></a>
				<%--员工注入 --%> <a
				href="${pageContext.request.contextPath}/uiAction.do?uri=/staff/addStaff">
					<img
	...
	<!-- 查询条件：马上查询 -->
	<form id="conditionFormId"
		action="${pageContext.request.contextPath}/staff/list.do"
		method="post">
