...
<body>
	...
	<table border="0" cellspacing="0" cellpadding="0" class="wukuang"
		...
		<tr>
			...
			<td width="57%" align="right">
				<%--添加职务 --%> <a
				href="${pageContext.request.contextPath}/uiAction.do?uri=/post/addOrEditPost">
					<img
	...
	<table width="100%" border="1">
		...
		<c:forEach items="${list}" var="post" varStatus="i">
			<tr class="tabtd1">
				<td align="center">${post.department.depname}</td>
				<td align="center">${post.postname}</td>
				<td width="7%" align="center"><a
				href="${pageContext.request.contextPath}/post/edit.do?postid=${post.postid}"><img
